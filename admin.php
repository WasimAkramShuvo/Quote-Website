...
<div id="d"> 
	 	<form action="admin.php" method="POST" align="center"> 
	 		...
	 		<br>
			  <p><button class="button"><a href="add_quote.php">Add Quote</a></button></p>
			  
			  <p><button class="button"><a href="view_quote.php">View Quote</a></button></p>

	 		  <p><button type="submit" class="btn btn-success" value="Log-out"><a href="index.php">Log-Out</a></button></p>
	 	</form>
</div>
